...
Chỉnh sửa sản phẩm đã chọn. Vui lòng bấm lưu để cập nhật!
@endsection

@section('content')
<form id="frmSP" name="frmSP" method="post" action="{{ route('admin.sanpham.update', ['id'=>$sp->sp_ma]) }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="sp_giamGia" name="sp_giamGia" value="{{ old('sp_giamGia', $sp->sp_giamgia) }}">
    </div>
    <div class="form-group">
        <div class="file-loading">
            ...
            <div class="preview-upload">
                ...
                <img src="{{ asset('storage/photos/' . $sp->sp_hinh) }}" id="sp_hinh-upload" />
            </div>
        </div>
    </div>
    <div class="form-group">
        <label for="sp_mota">Thông tin</label>
        <input type="text" class="form-control" id="sp_mota" name="sp_mota" value="{{ old('sp_mota', $sp->sp_mota) }}">
    </div>
    <div class="form-group">
